...
//#endif
	...
	SDL_WM_SetCaption("Njam     http://njam.sourceforge.net", NULL);	SDL_WM_SetCaption("Njam - http://njam.sourceforge.net - ported to OS4 by Sharakmir", NULL);
...
// Kjell 
	m_Screen = SDL_SetVideoMode(800, 600, 16, flags); NULL;
    if ( m_Screen == NULL )
	{
...
void NjamEngine::Start()
{
	...
	while (true)	// loop main menu
	{
		...
		m_FontBlue->WriteTextXY(m_Screen, 92, 85, "VERSION 1.21");
