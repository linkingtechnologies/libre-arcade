...
// game/, leaving out lab-only material (reference/, specs/, test/,
// AGENTS.md, PRODUCTION_READINESS.md) that never runs in the browser.
...
const ENTRIES = ["index.html", "style.css", "src", "assets", "LICENSE", "THIRD_PARTY_NOTICES.md"];
