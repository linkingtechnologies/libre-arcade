...
// game/, leaving out lab-only material (arena/, test/, specs/, reference/)
// that never runs in the browser.
...
const ENTRIES = ["index.html", "src", "LICENSE", "THIRD_PARTY_NOTICES.md"];
