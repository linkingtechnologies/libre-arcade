...
import { arenaPlayers } from "./lib/players.mjs";
...
const seedPairs = Number(process.argv[2] ?? 1000);
const seedStart = Number(process.argv[3] ?? 1);
const outputBase = resolveProjectPath(process.argv[4] ?? "arena/results/latest-round-robin");
