    ...
    #include "pegController.h"
        NKlein_54321::PegController::PegController(
                SDL_Surface* _screen,
                SoundDev* _sound,
                Cube* _cube,
                unsigned int _dims,
        ...
        NKlein_54321::PegController::~PegController( void )
        {
            this->view.backgroundMusic( true );
            delete this->model;
        }
        void
        NKlein_54321::PegController::reset( void )
        {
            delete this->model;
            this->model = new Peg(
                    this->cube,
        ...
        void
        NKlein_54321::PegController::setDimension(
                unsigned int _dims
            )
        {
            if ( _dims != this->dims ) {
        ...
        void
        NKlein_54321::PegController::setSkillLevel(
                unsigned int _skillLevel
            )
        {
        ...
        void
        NKlein_54321::PegController::setWrap(
                bool _wrap
            )
        {
            if ( _wrap != this->wrap ) {
        ...
        void
        NKlein_54321::PegController::newGame( void )
        {
            this->reset();
        }
        void
        NKlein_54321::PegController::handleMouseClick(
                bool isMouseUp,
                unsigned int xx,
                unsigned int yy,
